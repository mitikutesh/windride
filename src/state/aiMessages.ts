...
export function aiFailureReason(e: unknown, feature: string): string {
  if (isProviderError(e)) {
    ...
    if (e.kind === 'network') {
      ...
      // more often a rejected/misconfigured key than a connection problem.
      return e.code === 'offline' || isBrowserOffline()
        ? 'You appear to be offline. Check your connection.'
        : 'Couldn’t reach the AI provider even though you seem to be online — check your key in Kit → AI and try again.';
    }
  }
